            ...
            try {
                ...
                if (resource === 'transcription') {
                    if (operation === 'create') {
                        ...
                        responseData = await this.helpers.httpRequestWithAuthentication.call(this, 'getTranscribeApi', options);
                    }
...
exports.GetTranscribe = GetTranscribe;
//# sourceMappingURL=GetTranscribe.node.js.map